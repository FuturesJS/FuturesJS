...
(function () {     
  var public_methods,
    ignore_me; // For my own shorthand of truth statments which doesn't pass JSLint
...
/*
  ...
  Object.keys(public_methods).forEach(function (key) {
    Futures[key] = public_methods[key];
  });
}());
