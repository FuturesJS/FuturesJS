...
var Futures;
(function () {     
  Futures = require('./private');
  Futures.extend(Futures, require('./promise'));
  Futures.extend(Futures, require('./subscription'));
  Futures.extend(Futures, require('./chainify'));
  Futures.extend(Futures, require('./util'));
  Futures.extend(Futures, require('./deprecated'));
